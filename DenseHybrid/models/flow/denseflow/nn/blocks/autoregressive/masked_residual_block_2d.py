...
from models.flow.denseflow.nn.layers.autoregressive import MaskedConv2d, SpatialMaskedConv2d
...
class MaskedResidualBlock2d(nn.Module):
    ...
    def __init__(self, h, kernel_size=3, data_channels=3):
        ...
        self.conv2 = MaskedConv2d(h, h, kernel_size=kernel_size, padding=kernel_size // 2, mask_type='B',
