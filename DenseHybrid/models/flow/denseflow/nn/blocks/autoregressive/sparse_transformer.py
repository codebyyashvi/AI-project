...
from models.flow.denseflow.nn.layers import act_module
...
class DenseTransformerBlock(nn.Module):
    ...
    def __init__(self, d_model, nhead, dim_feedforward=512, dropout=0.1, activation="gelu", kdim=None, vdim=None,
                 attn_bias=True, checkpoint=False):
