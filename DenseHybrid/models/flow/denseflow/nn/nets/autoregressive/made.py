...
from models.flow.denseflow.nn.layers import act_module, ElementwiseParams
from models.flow.denseflow.nn.layers.autoregressive import MaskedLinear
    ...
    def __init__(self,
        ...
        for i, out_features in enumerate(hidden_features):
            layers.append(MaskedLinear(in_degrees=in_degrees,
                                       ...
                                       # Change random seed to get different masks
                                       is_output=False))
