...
from models.flow.denseflow.transforms.bijections.autoregressive import AutoregressiveBijection
...
class LinearSplineAutoregressiveBijection(AutoregressiveBijection):
    ...
    def __init__(self, autoregressive_net, num_bins, autoregressive_order='ltr'):
        super(LinearSplineAutoregressiveBijection, self).__init__(autoregressive_net=autoregressive_net,
...
class QuadraticSplineAutoregressiveBijection(AutoregressiveBijection):
    ...
    def __init__(self, autoregressive_net, num_bins, autoregressive_order='ltr'):
        super(QuadraticSplineAutoregressiveBijection, self).__init__(autoregressive_net=autoregressive_net,
                                                                     autoregressive_order=autoregressive_order)
        self.num_bins = num_bins
...
class CubicSplineAutoregressiveBijection(AutoregressiveBijection):
    ...
    def __init__(self, autoregressive_net, num_bins, autoregressive_order='ltr'):
        super(CubicSplineAutoregressiveBijection, self).__init__(autoregressive_net=autoregressive_net,
                                                                 autoregressive_order=autoregressive_order)
        self.num_bins = num_bins
...
class RationalQuadraticSplineAutoregressiveBijection(AutoregressiveBijection):
    ...
    def __init__(self, autoregressive_net, num_bins, autoregressive_order='ltr'):
        super(RationalQuadraticSplineAutoregressiveBijection, self).__init__(autoregressive_net=autoregressive_net,
                                                                             autoregressive_order=autoregressive_order)
        self.num_bins = num_bins
