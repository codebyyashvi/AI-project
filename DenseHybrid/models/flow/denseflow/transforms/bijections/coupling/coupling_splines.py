...
from models.flow.denseflow.transforms.bijections.coupling import CouplingBijection
...
class LinearSplineCouplingBijection(CouplingBijection):
    ...
    def __init__(self, coupling_net, num_bins, split_dim=1, num_condition=None):
        super(LinearSplineCouplingBijection, self).__init__(coupling_net=coupling_net, split_dim=split_dim,
...
class QuadraticSplineCouplingBijection(CouplingBijection):
    ...
    def __init__(self, coupling_net, num_bins, split_dim=1, num_condition=None):
        super(QuadraticSplineCouplingBijection, self).__init__(coupling_net=coupling_net, split_dim=split_dim,
                                                               num_condition=num_condition)
        self.num_bins = num_bins
...
class CubicSplineCouplingBijection(CouplingBijection):
    ...
    def __init__(self, coupling_net, num_bins, split_dim=1, num_condition=None):
        super(CubicSplineCouplingBijection, self).__init__(coupling_net=coupling_net, split_dim=split_dim,
                                                           num_condition=num_condition)
        self.num_bins = num_bins
...
class RationalQuadraticSplineCouplingBijection(CouplingBijection):
    ...
    def __init__(self, coupling_net, num_bins, split_dim=1, num_condition=None):
        super(RationalQuadraticSplineCouplingBijection, self).__init__(coupling_net=coupling_net, split_dim=split_dim,
                                                                       num_condition=num_condition)
        self.num_bins = num_bins
