...
from models.flow.denseflow.transforms.bijections.functional.iterative_inversion import bisection_inverse
from models.flow.denseflow.transforms.bijections.functional.mixtures.utils_logistic_censored import cmol_cdf, \
    cmol_log_pdf


def censored_logistic_mixture_transform(inputs, logit_weights, means, log_scales, num_bins=256, eps=1e-10,
                                        max_iters=100, inverse=False):
    '''
