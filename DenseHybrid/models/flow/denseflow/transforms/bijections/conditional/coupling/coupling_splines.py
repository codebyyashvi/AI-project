...
from models.flow.denseflow.transforms.bijections.conditional.coupling import ConditionalCouplingBijection
...
class ConditionalLinearSplineCouplingBijection(ConditionalCouplingBijection):
    ...
    def __init__(self, coupling_net, num_bins, context_net=None, split_dim=1, num_condition=None):
        super(ConditionalLinearSplineCouplingBijection, self).__init__(coupling_net=coupling_net,
                                                                       context_net=context_net, split_dim=split_dim,
...
class ConditionalQuadraticSplineCouplingBijection(ConditionalCouplingBijection):
    ...
    def __init__(self, coupling_net, num_bins, context_net=None, split_dim=1, num_condition=None):
        super(ConditionalQuadraticSplineCouplingBijection, self).__init__(coupling_net=coupling_net,
                                                                          context_net=context_net, split_dim=split_dim,
                                                                          num_condition=num_condition)
        self.num_bins = num_bins
...
class ConditionalCubicSplineCouplingBijection(ConditionalCouplingBijection):
    ...
    def __init__(self, coupling_net, num_bins, context_net=None, split_dim=1, num_condition=None):
        super(ConditionalCubicSplineCouplingBijection, self).__init__(coupling_net=coupling_net,
                                                                      context_net=context_net, split_dim=split_dim,
                                                                      num_condition=num_condition)
        self.num_bins = num_bins
...
class ConditionalRationalQuadraticSplineCouplingBijection(ConditionalCouplingBijection):
    ...
    def __init__(self, coupling_net, num_bins, context_net=None, split_dim=1, num_condition=None):
        super(ConditionalRationalQuadraticSplineCouplingBijection, self).__init__(coupling_net=coupling_net,
