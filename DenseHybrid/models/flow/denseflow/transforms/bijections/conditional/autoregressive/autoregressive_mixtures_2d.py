...
from models.flow.denseflow.transforms.bijections.functional.mixtures import gaussian_mixture_transform, \
    logistic_mixture_transform, censored_logistic_mixture_transform
from models.flow.denseflow.transforms.bijections.functional.mixtures import get_mixture_params
...
class ConditionalGaussianMixtureAutoregressiveBijection2d(ConditionalAutoregressiveBijection2d):
    ...
    def __init__(self, autoregressive_net, num_mixtures, autoregressive_order='raster_cwh'):
        super(ConditionalGaussianMixtureAutoregressiveBijection2d, self).__init__(autoregressive_net=autoregressive_net,
...
class ConditionalLogisticMixtureAutoregressiveBijection2d(ConditionalAutoregressiveBijection2d):
    ...
    def __init__(self, autoregressive_net, num_mixtures, autoregressive_order='raster_cwh'):
        super(ConditionalLogisticMixtureAutoregressiveBijection2d, self).__init__(autoregressive_net=autoregressive_net,
                                                                                  autoregressive_order=autoregressive_order)
        self.num_mixtures = num_mixtures
        self.set_bisection_params()
...
class ConditionalCensoredLogisticMixtureAutoregressiveBijection2d(ConditionalAutoregressiveBijection2d):
    ...
    def __init__(self, autoregressive_net, num_mixtures, num_bins, autoregressive_order='raster_cwh'):
        super(ConditionalCensoredLogisticMixtureAutoregressiveBijection2d, self).__init__(
