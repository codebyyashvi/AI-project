...
class SemsegADENegativesTrafficExperiment(Experiment):

    def __init__(self, model, optimizer, loaders, epochs, logger, device, cp_file, args, img_dir, data_loader):
        super(SemsegADENegativesTrafficExperiment, self).__init__(model, optimizer, loaders, epochs, logger, device,
                                                                  cp_file, args)
